...
function Flag({ name, set }: FlagProps) {
	return (
		<div className={classes.register}>
			<span className={classes.name}>{name}</span>
			<div className={set ? classes.checked : classes.unchecked} />
		</div>
	);
}
	...
	return (
		<div className={classes.registers}>
			...
			<div className={classes.flags}>
				...
				<Flag name="U" set={(regs.sc & 0b100000) !== 0} />
				<Flag name="D" set={(regs.sc & 0b010000) !== 0} />
				<Flag name="N" set={(regs.sc & 0b001000) !== 0} />
				<Flag name="V" set={(regs.sc & 0b000100) !== 0} />
				<Flag name="C" set={(regs.sc & 0b000010) !== 0} />
				<Flag name="Z" set={(regs.sc & 0b000001) !== 0} />
			</div>
		</div>
	);
}
